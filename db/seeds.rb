...
# seeds de vaccine_types
  ...
  VaccineType.create(name:'Vacinas combinadas à DTPa', prevents: 'DTPa-VIP/Hib: difteria, tétano, coqueluche, meningite por Haemophilus influenzae tipo b e poliomielite. DTPa-VIP-HB/Hib: difteria, tétano, coqueluche, meningite por Haemophilus influenzae tipo b, poliomielite e hepatite B.', composition:'Tratam-se de vacinas inativadas, portanto, não têm como causar doença.', indication:'As duas vacinas são recomendadas para crianças a partir de 2 meses de idade e podem ser aplicadas até os 7 anos, sempre que seja indicada cada uma das vacinas incluídas nessas combinações.')
  ...
  VaccineType.create(name:'Vacinas poliomielite - VIP', prevents: 'Poliomielite (paralisia infantil).', composition:'Vacina Oral Poliomielite (VOP) – É uma vacina oral atenuada bivalente, ou seja, composta pelos vírus da pólio tipos 1 e 3, vivos, mas “enfraquecidos”. Contém ainda cloreto de magnésio, estreptomicina, eritromicina, polissorbato 80, L-arginina e água destilada.', indication:'Desde 2016, o Programa Nacional de Imunizações (PNI) adota a vacina VIP nas três primeiras doses do primeiro ano de vida (aos 2, 4 e 6 meses de idade) e a VOP no reforço e campanhas anuais de vacinação.')
  VaccineType.create(name:'Vacinas poliomielite - VOP', prevents: 'Poliomielite (paralisia infantil).', composition:'Vacina Oral Poliomielite (VOP) – É uma vacina oral atenuada bivalente, ou seja, composta pelos vírus da pólio tipos 1 e 3, vivos, mas “enfraquecidos”. Contém ainda cloreto de magnésio, estreptomicina, eritromicina, polissorbato 80, L-arginina e água destilada.', indication:'Desde 2016, o Programa Nacional de Imunizações (PNI) adota a vacina VIP nas três primeiras doses do primeiro ano de vida (aos 2, 4 e 6 meses de idade) e a VOP no reforço e campanhas anuais de vacinação.')
  ...
  # seeds de vaccine 0 a 10 vacinas para cada usuario Cidadão
   ...
   # seed com o calendário de vacinação do SUS de criança https://antigo.saude.gov.br/saude-de-a-z/vacinacao/vacine-se#calendario

   SuggestedDose.create(month_age: 0, description: 'Dose única', vaccine_type_id: VaccineType.find_by(name: 'Vacina BCG'))
   SuggestedDose.create(month_age: 0, description: 'Dose ao nascer', vaccine_type_id: VaccineType.find_by(name: 'Vacina hepatite B'))
   SuggestedDose.create(month_age: 2, description: '3 doses, 2 reforços com a vacina VOP', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VIP'))
   SuggestedDose.create(month_age: 4, description: '3 doses, 2 reforços com a vacina VOP', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VIP'))
   SuggestedDose.create(month_age: 6, description: '3 doses, 2 reforços com a vacina VOP', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VIP'))

   SuggestedDose.create(month_age: 15, description: '2 doses de reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VOP'))
   SuggestedDose.create(month_age: 48, description: '2 doses de reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VOP'))

   SuggestedDose.create(month_age: 2, description: '2 doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina rotavírus'))
   SuggestedDose.create(month_age: 4, description: '2 doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina rotavírus'))

   SuggestedDose.create(month_age: 2, description: '3 doses, 2 reforços com a vacina DTP', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana de células inteiras combinada com Hib e hepatite B (DTPw­-HB/Hib)'))
   SuggestedDose.create(month_age: 4, description: '3 doses, 2 reforços com a vacina DTP', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana de células inteiras combinada com Hib e hepatite B (DTPw­-HB/Hib)'))
   SuggestedDose.create(month_age: 6, description: '3 doses, 2 reforços com a vacina DTP', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana de células inteiras combinada com Hib e hepatite B (DTPw­-HB/Hib)'))

   SuggestedDose.create(month_age: 2, description: '2 doses, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas pneumocócicas conjugadas'))
   SuggestedDose.create(month_age: 4, description: '2 doses, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas pneumocócicas conjugadas'))
   SuggestedDose.create(month_age: 12, description: '2 doses, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas pneumocócicas conjugadas'))

   SuggestedDose.create(month_age: 3, description: '2 doses, 1º reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina meningocócica C conjugada'))
   SuggestedDose.create(month_age: 5, description: '2 doses, 1º reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina meningocócica C conjugada'))
   SuggestedDose.create(month_age: 12, description: '2 doses, 1º reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina meningocócica C conjugada'))

   SuggestedDose.create(month_age: 9, description: '1 dose, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina febre amarela – FA'))
   SuggestedDose.create(month_age: 48, description: '1 dose, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina febre amarela – FA'))

   SuggestedDose.create(month_age: 12, description: '2 doses (1ª dose com SCR e 2ª dose com SCRV)', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice viral (sarampo, caxumba e rubéola) – SCR'))
   SuggestedDose.create(month_age: 15, description: '1 dose (corresponde a segunda dose da SCR e primeira de varicela', vaccine_type_id: VaccineType.find_by(name: 'Vacina tetraviral (sarampo, caxumba, rubéola e varicela) – SCR-V'))

   SuggestedDose.create(month_age: 15, description: '1 dose', vaccine_type_id: VaccineType.find_by(name: 'Vacina hepatite A'))
   SuggestedDose.create(month_age: 15, description: 'Considerar doses anteriores (3 doses)', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana acelular infantil – DTPa'))
   SuggestedDose.create(month_age: 48, description: 'Considerar doses anteriores (3 doses)', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana acelular infantil – DTPa'))

   SuggestedDose.create(month_age: 120, description: '3 doses Considerar doses anteriores com penta e DTP', vaccine_type_id: VaccineType.find_by(name: 'Vacina dupla bacteriana infantil – DT'))
   SuggestedDose.create(month_age: 108, description: '2 doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina HPV4'))
   SuggestedDose.create(month_age: 168, description: '2 doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina HPV4'))

   SuggestedDose.create(month_age: 60, description: '1 dose. Uma dose a depender da situação vacinal anterior com a PNM10v', vaccine_type_id: VaccineType.find_by(name: 'Vacina pneumocócica polissacarídica 23-valente – VPP23'))
   SuggestedDose.create(month_age: 48, description: '1 dose (corresponde a segunda dose da varicela)', vaccine_type_id: VaccineType.find_by(name: 'Vacina varicela (catapora)'))
   SuggestedDose.create(month_age: 12, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente'))
   SuggestedDose.create(month_age: 24, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente'))
   SuggestedDose.create(month_age: 36, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente'))
   SuggestedDose.create(month_age: 48, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente'))
   SuggestedDose.create(month_age: 60, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente'))
   SuggestedDose.create(month_age: 72, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente'))
