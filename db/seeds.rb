...
# seeds de vaccine_types
  ...
  # seeds de vaccine 0 a 10 vacinas para cada usuario Cidadão
   ...
   SuggestedDose.create(month_age: 0, description: 'Dose única', vaccine_type_id: VaccineType.find_by(name: 'Vacina BCG').id)
   SuggestedDose.create(month_age: 0, description: 'Dose ao nascer', vaccine_type_id: VaccineType.find_by(name: 'Vacina hepatite B').id)
   SuggestedDose.create(month_age: 2, description: '3 doses, 2 reforços com a vacina VOP', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VIP').id)
   SuggestedDose.create(month_age: 4, description: '3 doses, 2 reforços com a vacina VOP', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VIP').id)
   SuggestedDose.create(month_age: 6, description: '3 doses, 2 reforços com a vacina VOP', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VIP').id)

   SuggestedDose.create(month_age: 15, description: '2 doses de reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VOP').id)
   SuggestedDose.create(month_age: 48, description: '2 doses de reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas poliomielite - VOP').id)

   SuggestedDose.create(month_age: 2, description: '2 doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina rotavírus').id)
   SuggestedDose.create(month_age: 4, description: '2 doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina rotavírus').id)

   SuggestedDose.create(month_age: 2, description: '3 doses, 2 reforços com a vacina DTP', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana de células inteiras combinada com Hib e hepatite B (DTPw­-HB/Hib)').id)
   SuggestedDose.create(month_age: 4, description: '3 doses, 2 reforços com a vacina DTP', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana de células inteiras combinada com Hib e hepatite B (DTPw­-HB/Hib)').id)
   SuggestedDose.create(month_age: 6, description: '3 doses, 2 reforços com a vacina DTP', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana de células inteiras combinada com Hib e hepatite B (DTPw­-HB/Hib)').id)

   SuggestedDose.create(month_age: 2, description: '2 doses, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas pneumocócicas conjugadas').id)
   SuggestedDose.create(month_age: 4, description: '2 doses, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas pneumocócicas conjugadas').id)
   SuggestedDose.create(month_age: 12, description: '2 doses, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacinas pneumocócicas conjugadas').id)

   SuggestedDose.create(month_age: 3, description: '2 doses, 1º reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina meningocócica C conjugada').id)
   SuggestedDose.create(month_age: 5, description: '2 doses, 1º reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina meningocócica C conjugada').id)
   SuggestedDose.create(month_age: 12, description: '2 doses, 1º reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina meningocócica C conjugada').id)

   SuggestedDose.create(month_age: 9, description: '1 dose, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina febre amarela – FA').id)
   SuggestedDose.create(month_age: 48, description: '1 dose, reforço', vaccine_type_id: VaccineType.find_by(name: 'Vacina febre amarela – FA').id)

   SuggestedDose.create(month_age: 12, description: '2 doses (1ª dose com SCR e 2ª dose com SCRV)', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice viral (sarampo, caxumba e rubéola) – SCR').id)
   SuggestedDose.create(month_age: 15, description: '1 dose (corresponde a segunda dose da SCR e primeira de varicela', vaccine_type_id: VaccineType.find_by(name: 'Vacina tetraviral (sarampo, caxumba, rubéola e varicela) – SCR-V').id)

   SuggestedDose.create(month_age: 15, description: '1 dose', vaccine_type_id: VaccineType.find_by(name: 'Vacina hepatite A'))
   SuggestedDose.create(month_age: 15, description: 'Considerar doses anteriores (3 doses)', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana acelular infantil – DTPa').id)
   SuggestedDose.create(month_age: 48, description: 'Considerar doses anteriores (3 doses)', vaccine_type_id: VaccineType.find_by(name: 'Vacina tríplice bacteriana acelular infantil – DTPa').id)

   SuggestedDose.create(month_age: 120, description: '3 doses Considerar doses anteriores com penta e DTP', vaccine_type_id: VaccineType.find_by(name: 'Vacina dupla bacteriana infantil – DT').id)
   SuggestedDose.create(month_age: 108, description: '2 doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina HPV4').id)
   SuggestedDose.create(month_age: 168, description: '2 doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina HPV4').id)

   SuggestedDose.create(month_age: 60, description: '1 dose. Uma dose a depender da situação vacinal anterior com a PNM10v', vaccine_type_id: VaccineType.find_by(name: 'Vacina pneumocócica polissacarídica 23-valente – VPP23').id)
   SuggestedDose.create(month_age: 48, description: '1 dose (corresponde a segunda dose da varicela)', vaccine_type_id: VaccineType.find_by(name: 'Vacina varicela (catapora)').id)
   SuggestedDose.create(month_age: 12, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente').id)
   SuggestedDose.create(month_age: 24, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente').id)
   SuggestedDose.create(month_age: 36, description: '1 dose ou duas doses', vaccine_type_id: VaccineType.find_by(name: 'Vacina gripe (influenza) — trivalente ou quadrivalente').id)
